...
public class TaskDTO {
	...
	@Data
	public static class SaveTaskGroup implements Serializable {
	...
	@Builder
	@Data
	public static class SaveTask implements Serializable {			
		...
		public static SaveTask convert(Task entity) {
			return SaveTask.builder()
